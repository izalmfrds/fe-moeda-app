  ...
  return (
    <div className="w-full rounded-2xl overflow-hidden shadow-md bg-white flex flex-col h-full">
      ...
      <div className="p-2 flex flex-col flex-1">
        ...
        <button
          className="mt-4 w-full flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-800 text-white text-sm font-semibold py-1 rounded-[8px] flex-shrink-0"
          onClick={onAddToCart}
        >
